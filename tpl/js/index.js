...
requirejs(['jquery', 'cookie', 'uikit', 'notie', 'base', "JQmd5", "JQbase64", "notify"], function($) {
	if (!$('#psw2').hasClass('uk-hidden')) {
		notie.alert(3, "欢迎" + $.cookie('klbweixinusername') + "<br/>工号" + $.cookie('klbweixinusercode') + "登录!<br/>请设置你的查询密码!", 10000000);
	} else {
		notie.alert(1, "欢迎" + $.cookie('klbweixinusername') + "<br/>工号" + $.cookie('klbweixinusercode') + "登录!", 1000000);
	}
